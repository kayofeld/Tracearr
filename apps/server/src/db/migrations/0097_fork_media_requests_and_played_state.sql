CREATE TABLE "media_request_user_mappings" (
...
--> statement-breakpoint
ALTER TABLE "media_request_user_mappings" ADD CONSTRAINT "media_request_user_mappings_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "media_requests" ADD CONSTRAINT "media_requests_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "media_requests_user_id_idx" ON "media_requests" USING btree ("user_id");--> statement-breakpoint
...
CREATE INDEX "media_requests_imdb_partial" ON "media_requests" USING btree ("imdb_id") WHERE "media_requests"."imdb_id" IS NOT NULL;--> statement-breakpoint
CREATE INDEX "media_requests_tmdb_partial" ON "media_requests" USING btree ("tmdb_id") WHERE "media_requests"."tmdb_id" IS NOT NULL;--> statement-breakpoint
CREATE INDEX "media_requests_tvdb_partial" ON "media_requests" USING btree ("tvdb_id") WHERE "media_requests"."tvdb_id" IS NOT NULL;--> statement-breakpoint
...
CREATE INDEX "played_states_user_synced_idx" ON "played_states" USING btree ("server_user_id","synced_at");--> statement-breakpoint
CREATE UNIQUE INDEX "servers_single_emby" ON "servers" USING btree ("type") WHERE type = 'emby';--> statement-breakpoint
CREATE UNIQUE INDEX "users_single_owner" ON "users" USING btree ("role") WHERE role = 'owner';